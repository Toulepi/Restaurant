 ...
 */
final class Version20200905070742 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE plat (id INT AUTO_INCREMENT NOT NULL, nom_plat VARCHAR(150) NOT NULL, prix_u_ht NUMERIC(5, 2) NOT NULL, description LONGTEXT NOT NULL, imd_name VARCHAR(150) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE entree_dessert (id INT AUTO_INCREMENT NOT NULL, nom_entr_dess VARCHAR(100) NOT NULL, prix_ent_dss NUMERIC(5, 2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE complement (id INT AUTO_INCREMENT NOT NULL, plat_id INT DEFAULT NULL, nom_complement VARCHAR(150) NOT NULL, INDEX IDX_F8A41E34D73DB560 (plat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, plat_id INT DEFAULT NULL, client_id INT DEFAULT NULL, contenu LONGTEXT DEFAULT NULL, date_commentaire DATE NOT NULL, avis INT DEFAULT NULL, INDEX IDX_67F068BCD73DB560 (plat_id), INDEX IDX_67F068BC19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE boisson (id INT AUTO_INCREMENT NOT NULL, nom_boisson VARCHAR(50) NOT NULL, prix_boisson NUMERIC(5, 2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ligne_commande (id INT AUTO_INCREMENT NOT NULL, commande_id INT NOT NULL, boisson_id INT DEFAULT NULL, entree_dessert_id INT DEFAULT NULL, plat_id INT DEFAULT NULL, qte INT NOT NULL, pourcent_remise NUMERIC(5, 2) DEFAULT NULL, INDEX IDX_3170B74B82EA2E54 (commande_id), INDEX IDX_3170B74B734B8089 (boisson_id), INDEX IDX_3170B74BFFC9808 (entree_dessert_id), INDEX IDX_3170B74BD73DB560 (plat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
