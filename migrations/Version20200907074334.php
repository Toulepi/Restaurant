 ...
 */
final class Version20200907074334 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, boisson_id INT DEFAULT NULL, plat_id INT DEFAULT NULL, entree_dessert_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_29A5EC27734B8089 (boisson_id), UNIQUE INDEX UNIQ_29A5EC27D73DB560 (plat_id), UNIQUE INDEX UNIQ_29A5EC27FFC9808 (entree_dessert_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ligne_commande (id INT AUTO_INCREMENT NOT NULL, commande_id INT NOT NULL, type_produit_id INT DEFAULT NULL, qte INT NOT NULL, pourcent_remise NUMERIC(5, 2) DEFAULT NULL, identifiant_produit INT NOT NULL, INDEX IDX_3170B74B82EA2E54 (commande_id), INDEX IDX_3170B74B1237A8DE (type_produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ligne_commande ADD CONSTRAINT FK_3170B74B1237A8DE FOREIGN KEY (type_produit_id) REFERENCES produit (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ligne_commande DROP FOREIGN KEY FK_3170B74B1237A8DE');
